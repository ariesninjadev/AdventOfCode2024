    ...
    private static class AntennaCluster {
        ...
        public Point[] antinodes() {
            ...
            for (int i = 0; i < choose(antennas.size(), 2); i++) {
                ...
                ans.add(endpoint(antennas.get(left), antennas.get(right)));
                ans.add(endpoint(antennas.get(right), antennas.get(left)));
            }
